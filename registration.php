...
<br><br>Save this page to a PDF file and send to vetclinic.email@gmail.com
<br><br>
<?php
$mysqli = new mysqli('localhost', $user, mc_decrypt($_SESSION["up"], ps_key), '');
$sql = "SELECT * FROM `vetcliniccorp`.`company`;";
$result = $mysqli->query($sql);
if ($result == FALSE)
{
	put_errormsg("Cannot access vetcliniccorp.company table");
} else {
