...
if ($proccode <> "new")
{
	$sql = "UPDATE procedures SET `vetclinicproc`.`proccode` = \"".$proccode."\", `procdesc` = \"".$procdesc."\", `proctype` = \"".$proctype."\", `procstatus` = \"".$procstatus."\", ";
	...
	$sql = "INSERT INTO `vetclinicproc`.`procedures` (`procdesc`, `proctype`, `procstatus`, `changeid`)
