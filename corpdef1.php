...
//$sql="UPDATE `vetcliniccorp`.`preferences` SET `pref1` = \"".$pref1."\", `pref2` = \"".$pref2."\", `pref3` = \"".$pref3."\", `pref4` = \"".$pref4."\", `pref5` = \"".$pref5."\" WHERE `sequence` = 3";
$sql="UPDATE `vetcliniccorp`.`preferences` SET `pref1` = \"".$pref1."\", `pref2` = \"".$pref2."\", `pref3` = \"".$pref3."\", `pref4` = \"".$pref4."\" WHERE `sequence` = 3";
...
$sql="SELECT `pref1` FROM `vetcliniccorp`.`preferences` WHERE `sequence` = 4";
$result = $mysqli->query($sql);
if ($result == FALSE)
{
     ...
     if ($row_cnt == 0) {
          ...
          exit(0);
               ...
               $sql="UPDATE `vetcliniccorp`.`preferences` SET `pref1` = \"".$pref1."\" WHERE `sequence` = 4";
               $result = $mysqli->query($sql);
          }
}
$mysqli->close();
